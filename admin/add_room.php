                       ...
                       <thead class="thead-light">
                        ...
                        if($selectclassquery){
                            while ($row = mysqli_fetch_assoc($selectclassquery)) {
                                $vacancy = $row['capacity'] - $row['filled']; // Corrected vacancy calculation
                                echo "<tr>
                                <td>".$row['room_no']."</td>
                                <td>".$row['floor']."</td>
                                <td>".$row['capacity']."</td>
                                <form action='display_allotment.php' method='post'>
                                <td> <button class='btn btn-light px-1 py-0' type='submit' value='".$row['rid']."' name='display'>See</button>
                                </td>
                                </form>
                                <td>
                                <form method='post'>
